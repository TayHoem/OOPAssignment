    ...
    public static void main(String args[]){
        ...
        if(confirmPayment == 'y'){ 
            ...
            if(confirmPayment == 'y'){
                ...
                do{
                    if(correctFormat > 0){
                    System.out.println("\nWrong Format of card number!!! It should be not more than 16 number\n");
                    }
                ...
                do{
                    if(correctFormat > 0){
                    System.out.println("\nWrong Format of CV number!!! It should be not more than 3 number\n");
                    }
