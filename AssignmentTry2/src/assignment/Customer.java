...
public class Customer extends Person {
    ...
    public static void customerAction(ArrayList<Customer> cust,ArrayList<Flight> flight,ArrayList<Seat> arrSeat,ArrayList<Payment> arrPayment,ArrayList<Ticket> arrTicket){
                ...
                switch (choose) {
                    case 1:
                        ...
                        do {
                            ...
                            if(book == 'Y'){
                           do{
                        back = cust.get(numOfCust).booking(flight, arrSeat, arrPayment, arrTicket, cust.get(numOfCust));
